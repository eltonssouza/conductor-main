...
description: "Application Security Engineer. Use para encontrar e prevenir vulnerabilidades em apps (sobretudo web): revisar contra OWASP ASVS/Top 10, análise taint (origem→sumidouro), pensar como atacante e fornecer correções com PoC e padrões seguros."
---
