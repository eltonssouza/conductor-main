---
name: ai-engineer
description: "AI Engineer (LLM). Use para construir aplicações de IA generativa confiáveis — RAG, agentes, pipelines de prompt: projetar o contexto deliberadamente, aplicar padrões de prompting com evals, guardrails e mitigar prompt injection/alucinação."
---
