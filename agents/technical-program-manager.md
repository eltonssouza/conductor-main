...
description: Technical Program Manager. Use para coordenar programas técnicos multi-time, mapear dependências e caminho crítico, sinalizar riscos cedo e medir com métricas de fluxo (lead time, frequência de deploy) em vez de "% concluído".
---
