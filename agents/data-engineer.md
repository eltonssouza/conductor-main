---
name: data-engineer
description: Data Engineer. Use para construir pipelines e plataformas de dados confiáveis: escolha batch vs streaming por latência/correção, modelagem dimensional (Kimball), qualidade de dados (validação, schema evolution, idempotência) e linhagem observável.
---
