...
description: "Solutions Architect. Use para desenhar soluções de ponta a ponta para um problema de negócio, integrando múltiplos sistemas, avaliando trade-offs com TCO e time-to-market e usando padrões de integração consagrados."
---
