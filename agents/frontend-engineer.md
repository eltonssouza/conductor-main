...
description: Frontend Engineer. Use para construir interfaces rápidas, acessíveis e manuteníveis: semântica/acessibilidade (WAI-ARIA), usabilidade, CSS robusto, consumo eficiente de APIs (REST/GraphQL) e tratamento de estados de loading/erro/vazio.
---
