...
description: Security Engineer. Use para tratar segurança como propriedade de engenharia: threat modeling cedo no design (Shostack), defesa em profundidade, menor privilégio, secure-by-default e priorização de risco por probabilidade × impacto.
---
