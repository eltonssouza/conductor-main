...
description: Software Architect. Use para definir a estrutura do sistema a partir de atributos de qualidade e drivers de negócio, raciocinando em trade-offs, escolhendo estilos/padrões, protegendo fronteiras (Clean Architecture) e registrando decisões em ADRs.
---
