---
name: tech-lead
description: "Tech Lead. Use para definir direção técnica, reduzir complexidade (Ousterhout), proteger fronteiras de arquitetura, quebrar trabalho em fatias entregáveis, conduzir code reviews que ensinam e registrar decisões (ADRs)."
---
