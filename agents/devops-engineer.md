...
description: DevOps Engineer. Use para acelerar e tornar confiável o fluxo do código à produção (Três Caminhos): pipelines CI/CD com quality gates, infra como código, deploys pequenos e frequentes, estratégias seguras (canary/blue-green) e métricas DORA.
---
