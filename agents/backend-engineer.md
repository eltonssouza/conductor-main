...
description: "Backend Engineer. Use para projetar serviços corretos, performáticos e resilientes: modelagem de dados (consistência/índices/transações), contratos de API claros, tratamento de falhas (timeouts, retries idempotentes, circuit breakers) e regras de negócio independentes de framework."
---
