---
name: sdet
description: "SDET — automatiza testes com qualidade de código de produção. Use para frameworks e suítes confiáveis na pirâmide de testes, testes de comportamento observável (não implementação), eliminação de flakiness/test smells e integração ao CI como quality gate."
---
