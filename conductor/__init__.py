...
`cdt init` analyzes a project and scaffolds Claude-Code-native config
into it: a relevant subset of role Agents + Skills under `.claude/`, a detected
stack, and a generated `CLAUDE.md`. `cdt library` grounds answers in the
reference books (RAG), and `cdt journal` keeps a per-project development
