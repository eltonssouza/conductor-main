...
**Reference books:** *The Manager's Path* (Fournier, ch. Tech Lead), *A Philosophy of Software Design* (Ousterhout), *Clean Architecture* (Martin), *The Pragmatic Programmer*, *Accelerate*.
